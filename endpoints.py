...
con_string = "mongodb+srv://keerthana:mak4800862@cluster0.6lyx4as.mongodb.net/?retryWrites=true&w=majority"

client = pymongo.MongoClient(con_string)

db = client.get_database('studentdetail')

user_collection = pymongo.collection.Collection(db, 'studentdetail') #(<database_name>,"<collection_name>")
